        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThumbnailFileId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SharedLink", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SharedLink_Files_CloudFileId",
                        column: x => x.CloudFileId,
                        principalTable: "Files",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SharedLink_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SharedLinkId = table.Column<long>(type: "bigint", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_TrafficLogs_SharedLink_SharedLinkId",
                        column: x => x.SharedLinkId,
                        principalTable: "SharedLink",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SharedLink_CloudFileId",
                table: "SharedLink",
                column: "CloudFileId");

            migrationBuilder.CreateIndex(
                name: "IX_SharedLink_CreatedByUserId",
                table: "SharedLink",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrafficLogs_SharedLinkId",
                table: "TrafficLogs",
                column: "SharedLinkId");
